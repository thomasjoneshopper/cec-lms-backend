...
BEGIN
    CREATE TABLE dbo.Users (
        ...
        role_title      VARCHAR(16)     NOT NULL DEFAULT ('reader'),
        ...
        CONSTRAINT CK_Users_role
            CHECK (role_title IN ('reader', 'admin'))
    );
END;
...
BEGIN
    CREATE TABLE dbo.Questions (
        ...
        body_en     NVARCHAR(MAX)   NOT NULL,
        body_es     NVARCHAR(MAX)   NOT NULL,
        hint_en     NVARCHAR(MAX)   NULL,
        hint_es     NVARCHAR(MAX)   NULL,
        ...
        CONSTRAINT UQ_Questions_ordinal
